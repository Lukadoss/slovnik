    ...
    <div class="mdl-grid">
        ...
        <div class="mdl-cell mdl-cell--4-col">
            <form action="/search" style="padding: 0 5%;" class="mdl-grid mdl-shadow--6dp mdl-color--white">
                ...
                <button type="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent mdl-cell mdl-cell--4-col mdl-cell--middle mdl-cell--2-offset-tablet">
